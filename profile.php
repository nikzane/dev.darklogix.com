...
<div id="main" role="main">
	<?php
		...
		//$breadcrumbs["New Crumb"] => "http://dev.darklogix.com/profile.php"
		$breadcrumbs["Kim Elms"] = "";
...
<!-- 			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4"> -->
			<div>
				<h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-file-o"></i> Kim Elms <span>> Profile </span></h1>
			</div>
			<!-- end col -->
										...
										<div>
											<div class="row">
												...
												<div class="col-sm-3 profile-pic">
													...
													<img src="<?php echo ASSETS_URL; ?>/img/avatars/KimElms.png">
<!--
...
-->
												...
												<div class="col-sm-6">
													<h1>Kim <span class="semi-bold">Elms</span>
													<br>
													<small> CEO, DarkLogix</small></h1>
		
													<ul class="list-unstyled">
														<li>
															<p class="text-muted">
																<i class="fa fa-phone"></i>&nbsp;&nbsp;(<span class="txt-color-darken">0403</span>) <span class="txt-color-darken">399</span> - <span class="txt-color-darken">887</span>
															</p>
														</li>
														<li>
															<p class="text-muted">
																<i class="fa fa-envelope"></i>&nbsp;&nbsp;<a href="mailto:kim@latent.ventures">kim@latent.ventures</a>
															</p>
														</li>
														<li>
															<p class="text-muted">
																<i class="fa fa-skype"></i>&nbsp;&nbsp;<span class="txt-color-darken">kim.elms</span>
															</p>
														</li>
<!--
														<li>
