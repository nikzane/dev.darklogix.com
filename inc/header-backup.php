...
-->
				...
				<div id="shortcut">
					<ul>
						<li>
							<a href="<?php echo APP_URL; ?>/tasks.php" class="jarvismetro-tile big-cubes bg-color-blueDark"> <span class="iconbox"> <i class="fa fa-tasks fa-4x"></i> <span>Tasks</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/projects.php" class="jarvismetro-tile big-cubes bg-color-blueDark"> <span class="iconbox"> <i class="fa fa-users fa-4x"></i> <span>Projects</span> </span> </a>
						</li>
						<li>
						<li>
							<a href="<?php echo APP_URL; ?>/timeline.php" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-list fa-4x"></i> <span>Timeline</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/calendar.php" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-calendar fa-4x"></i> <span>Calendar</span> </span> </a>
						</li>
					</ul>
				</div>
				<!-- END SHORTCUT AREA -->
