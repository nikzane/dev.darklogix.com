...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>DarkLogix </title>
...
Glass = .smart-style-5
Material Design = .smart-style-6 ("experimental") - CURRENT THEME
-->
	<body class="smart-style-6 fixed-header fixed-navigation" <?php echo implode(' ', array_map(function($prop, $value) {
			return $prop.'="'.$value.'"';
...
<!-- 						<span id="activity" class="activity-dropdown"> <i class="fa fa-user"></i> </span> -->
					...
					<div class="project-context hidden-xs">
						...
						<span class="label" style="color:#333!important;">Projects:</span>
						<span id="project-selector" class="popover-trigger-element dropdown-toggle" data-toggle="dropdown" style="color:#333!important;">Recent projects <i class="fa fa-angle-down"></i></span>

						<!-- Suggestion: populate this list with fetch and push technique -->
						<ul class="dropdown-menu">
							<li>
								<a href="javascript:void(0);">DarkLogix Security Interception Unit</a>
							</li>
							<li>
								<a href="javascript:void(0);">GIGA - Local Events Tracker</a>
							</li>
							<li class="divider"></li>
							<li>
					...
					<div class="pull-right">
						...
						<div id="hide-menu" class="btn-header pull-right">
							<span> <a href="javascript:void(0);" title="Collapse Menu" data-action="toggleMenu"><i style="color:#333!important;" class="fa fa-reorder"></i></a> </span>
						</div>
						<!-- end collapse menu -->
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>../img/avatars/KimElms.png" alt="Kim Elms" class="" />
								</a>
								<ul class="dropdown-menu pull-right">
									<li>
										<a href="javascript:void(0);" class="padding-10 padding-top-0 padding-bottom-0"><i style="color:#333!important;" class="fa fa-cog"></i> Setting</a>
									</li>
									<li class="divider"></li>
									<li>
										<a href="profile.php" class="padding-10 padding-top-0 padding-bottom-0"> <i style="color:#333!important;" class="fa fa-user"></i> <u>P</u>rofile</a>
									</li>
									<li class="divider"></li>
									<li>
									...
									<li class="divider"></li>
									<li>
										<a href="login.php" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i style="color:#333!important;" class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
									</li>
								</ul>
							</li>
						</ul>
-->
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/login.php" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i style="color:#333!important;" class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->

						<!-- search mobile button (this is hidden till mobile view port) -->
						<div id="search-mobile" class="btn-header transparent pull-right">
							<span> <a href="javascript:void(0)" title="Search"><i style="color:#333!important;" class="fa fa-search"></i></a> </span>
						</div>
						<!-- end search mobile button -->

						<!-- input: search field -->
						<form action="<?php echo APP_URL; ?>/search.php" class="header-search pull-right">
							<input style="color:#333!important;" type="text" name="param" placeholder="" id="search-fld">
							<button type="submit">
								<i style="color:#333!important;" class="fa fa-search"></i>
							</button>
							<a href="javascript:void(0);" id="cancel-search-js" title="Cancel Search"><i style="color:#333!important;" class="fa fa-times"></i></a>
						</form>
						<!-- end input: search field -->

						<!-- fullscreen button -->
						<div id="fullscreen" class="btn-header transparent pull-right">
							<span> <a href="javascript:void(0);" title="Full Screen" data-action="launchFullscreen"><i style="color:#333!important;" class="fa fa-arrows-alt"></i></a> </span>
						</div>
...
-->
				...
				<div id="shortcut">
					<ul>
						<li>
							<a href="<?php echo APP_URL; ?>/tasks.php" class="jarvismetro-tile big-cubes bg-color-blueDark"> <span class="iconbox"> <i class="fa fa-check-square fa-4x"></i> <span>Tasks</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/projects.php" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-users fa-4x"></i> <span>Projects</span> </span> </a>
						</li>
						<li>
						<li>
							<a href="<?php echo APP_URL; ?>/timeline.php" class="jarvismetro-tile big-cubes bg-color-blueDark"> <span class="iconbox"> <i class="fa fa-list fa-4x"></i> <span>Timeline</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/gallery.php" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-cubes fa-4x"></i> <span>Assets</span> </span> </a>
						</li>
						<li>
							<a href="<?php echo APP_URL; ?>/calendar.php" class="jarvismetro-tile big-cubes bg-color-blueDark"> <span class="iconbox"> <i class="fa fa-calendar fa-4x"></i> <span>Calendar</span> </span> </a>
						</li>
					</ul>
				</div>
				<!-- END SHORTCUT AREA -->
